function getHoney() {
    ...
    function md5(t) {
        t = t.toString()
        return crypto.update(t).digest('hex')
    }
...
console.log(get_signure(new Date() / 1e3))
